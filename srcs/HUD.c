...
void		HUD(t_fdf *data)
{
	...
	mlx_string_put(data->mlx_ptr, data->win_ptr, 5, 95, 0xcccccc, "Ajust high : R F   Invert : I -> ");
	mlx_string_put(data->mlx_ptr, data->win_ptr, 330, 95, 0xcccccc, ft_itoa(data->invert_high));
