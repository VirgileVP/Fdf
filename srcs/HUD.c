...
void		HUD_text(t_fdf *data)
{
	...
	mlx_string_put(data->mlx_ptr, data->win_ptr, 5, 95, 0xcccccc, "Ajust height : R F   Invert : I -> ");
	mlx_string_put(data->mlx_ptr, data->win_ptr, 345, 95, 0xcccccc, ft_itoa(data->invert_height));
